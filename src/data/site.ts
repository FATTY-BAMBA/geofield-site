...
export const projects: Project[] = [
  ...
  },
  {
    ...
    category: "鑽探",
    photoCount: 5,
    cardImage: "/images/projects/guanmiao-solar-borehole/field-drilling.webp",
    cardImageFit: "cover",
    detail: {
      contentStatus: "image-record",
      heroImage: "/images/projects/guanmiao-solar-borehole/field-drilling.webp",
      location: "臺南市關廟區",
      summary: "永鑫能源關廟太陽光電廠地基調查，影像呈現基地及道路旁的鑽探配置、調查孔作業與地下水位量測情形。",
      scope: [
        "基地地基調查",
        "現地鑽探作業",
        "調查孔地下水位量測",
      ...
      sections: [],
      photos: [
        { src: "/images/projects/guanmiao-solar-borehole/field-drilling.webp", caption: "關廟太陽光電廠基地鑽探作業" },
        { src: "/images/projects/guanmiao-solar-borehole/roadside-drilling.webp", caption: "道路旁調查孔與鑽探設備配置" },
        { src: "/images/projects/guanmiao-solar-borehole/borehole-b1.webp", caption: "B-1 調查孔現場作業紀錄" },
        { src: "/images/projects/guanmiao-solar-borehole/drilling-equipment.webp", caption: "鑽探機具與孔口配置" },
        { src: "/images/projects/guanmiao-solar-borehole/water-level-measurement.webp", caption: "調查孔地下水位量測紀錄" },
      ],
    },
  },
  {
    ...
    category: "鑽探",
    photoCount: 4,
    cardImage: "/images/projects/mituo-mihai-borehole/borehole-b2.webp",
    cardImageFit: "cover",
    detail: {
      contentStatus: "image-record",
      heroImage: "/images/projects/mituo-mihai-borehole/borehole-b2.webp",
      location: "高雄市彌陀區彌海段",
      summary: "高雄市彌陀區彌海段地基調查，影像記錄不同調查孔位的鑽探作業、設備配置與周邊基地環境。",
      scope: [
        "彌海段地基調查",
        "現地鑽探作業",
        "不同孔位作業紀錄",
      ...
      sections: [],
      photos: [
        { src: "/images/projects/mituo-mihai-borehole/borehole-b2.webp", caption: "彌海段 B-2 調查孔鑽探作業" },
        { src: "/images/projects/mituo-mihai-borehole/borehole-b1.webp", caption: "B-1 調查孔與現場設備" },
        { src: "/images/projects/mituo-mihai-borehole/borehole-b3.webp", caption: "B-3 調查孔現場鑽探紀錄" },
        { src: "/images/projects/mituo-mihai-borehole/borehole-b4.webp", caption: "B-4 調查孔作業與基地環境" },
      ],
    },
  },
  {
    ...
    rocYear: 109,
    rocYearEnd: 110,
    cardImage: "/images/projects/n3-373k-slope-repair/slope-aerial.webp",
    cardImageFit: "cover",
    detail: {
      contentStatus: "image-record",
      heroImage: "/images/projects/n3-373k-slope-repair/slope-aerial.webp",
      location: "國道3號南下373k路段",
      period: "民國109年至110年（2020–2021）",
      summary:
        "國道3號南下373k+300邊坡修復工程，整合坡面空拍、排水設施現況、裂縫量測及施工監造影像，呈現邊坡環境、平台截水溝施工與現場查驗紀錄。",
      scope: [
        "邊坡全景與排水設施現況紀錄",
        "排水溝裂縫現場量測",
        "平台截水與排水設施施工紀錄",
      ...
      sections: [],
      photos: [
        { src: "/images/projects/n3-373k-slope-repair/slope-aerial.webp", caption: "國道3號南下373k+300邊坡與修復設施全景" },
        { src: "/images/projects/n3-373k-slope-repair/drainage-aerial.webp", caption: "高速公路側坡面與排水設施空拍紀錄" },
        { src: "/images/projects/n3-373k-slope-repair/channel-condition.webp", caption: "坡面排水溝局部破損與裂縫紀錄" },
        { src: "/images/projects/n3-373k-slope-repair/crack-measurement.webp", caption: "排水溝裂縫現場量測", fit: "contain" },
  ...
  {
    slug: "south-link-jialu-fangye-slope-assessment",
    title: "南迴線加祿枋野間邊坡改善評估",
    category: "邊坡",
    photoCount: 5,
    cardImage: "/images/projects/south-link-jialu-fangye-slope-assessment/railway-slope-aerial.webp",
    cardImageFit: "cover",
    detail: {
      contentStatus: "image-record",
      heroImage: "/images/projects/south-link-jialu-fangye-slope-assessment/railway-slope-aerial.webp",
      location: "南迴線加祿至枋野間",
      summary: "南迴線加祿枋野間邊坡改善評估，透過沿線空拍、現場勘查與傾度盤量測，記錄鐵路旁邊坡、防護設施及周邊環境現況。",
      scope: [
        "鐵路沿線邊坡現況調查",
        "邊坡與防護設施空拍紀錄",
        "現場勘查與設施檢視",
      ...
      sections: [],
      photos: [
        { src: "/images/projects/south-link-jialu-fangye-slope-assessment/railway-slope-aerial.webp", caption: "南迴線加祿枋野間鐵路與邊坡設施空拍" },
        { src: "/images/projects/south-link-jialu-fangye-slope-assessment/slope-condition.webp", caption: "鐵路旁既有邊坡與防護設施現況" },
        { src: "/images/projects/south-link-jialu-fangye-slope-assessment/railway-corridor.webp", caption: "鐵路沿線與鄰近坡地環境" },
        { src: "/images/projects/south-link-jialu-fangye-slope-assessment/tilt-measurement.webp", caption: "傾度盤現場量測作業" },
        { src: "/images/projects/south-link-jialu-fangye-slope-assessment/field-inspection.webp", caption: "工程人員現場勘查與坡面設施檢視" },
      ],
    },
  },
  {
    ...
    photoCount: 5,
    rocYear: 110,
    cardImage: "/images/projects/daliao-road-resurfacing/pavement-milling.webp",
    cardImageFit: "cover",
    detail: {
      contentStatus: "image-record",
      heroImage: "/images/projects/daliao-road-resurfacing/pavement-milling.webp",
      location: "高雄市大寮區",
      period: "民國110年度（2021）",
      summary: "高雄市大寮區小型道路路面整修工程，影像涵蓋既有鋪面刨除、黏層噴灑、瀝青混凝土鋪築厚度抽查及材料取樣等施工與品質查驗過程。",
      scope: [
        "道路整修施工紀錄",
        "鋪築前置作業查驗",
        "瀝青混凝土鋪築厚度抽查",
      ...
      sections: [],
      photos: [
        { src: "/images/projects/daliao-road-resurfacing/pavement-milling.webp", caption: "既有道路鋪面刨除作業" },
        { src: "/images/projects/daliao-road-resurfacing/tack-coat.webp", caption: "瀝青鋪築前黏層噴灑作業" },
        { src: "/images/projects/daliao-road-resurfacing/road-work.webp", caption: "道路整修施工與現場環境" },
        { src: "/images/projects/daliao-road-resurfacing/thickness-check.webp", caption: "瀝青混凝土鋪築厚度抽查" },
        { src: "/images/projects/daliao-road-resurfacing/asphalt-sampling.webp", caption: "瀝青混凝土現場取樣紀錄" },
      ],
    },
  },
  {
    ...
    category: "監造",
    photoCount: 5,
    cardImage: "/images/projects/sizihwan-scenic-area/waterfront-walkway.webp",
    cardImageFit: "cover",
    detail: {
      contentStatus: "image-record",
      heroImage: "/images/projects/sizihwan-scenic-area/waterfront-walkway.webp",
      location: "高雄市西子灣風景區",
      summary: "高雄市西子灣風景區整建工程，影像呈現臨港步道、公共服務設施、無障礙動線及綠地休憩空間的現場環境。",
      scope: [
        "風景區公共工程監造",
        "步道與廣場鋪面紀錄",
        "無障礙動線與設施紀錄",
      ...
      sections: [],
      photos: [
        { src: "/images/projects/sizihwan-scenic-area/waterfront-walkway.webp", caption: "西子灣風景區臨港步道與鋪面" },
        { src: "/images/projects/sizihwan-scenic-area/public-facilities.webp", caption: "廣場鋪面與公共服務設施" },
        { src: "/images/projects/sizihwan-scenic-area/accessible-path.webp", caption: "無障礙坡道與人行動線銜接" },
        { src: "/images/projects/sizihwan-scenic-area/landscape-seating.webp", caption: "臨港綠地、植栽與休憩座椅" },
        { src: "/images/projects/sizihwan-scenic-area/pedestrian-route.webp", caption: "街區人行步道與周邊環境" },
      ],
    },
  },
  {
    ...
    photoCount: 5,
    rocYear: 101,
    cardImage: "/images/projects/jinshihu-detention-pond/boardwalk.webp",
    cardImageFit: "cover",
    detail: {
      contentStatus: "image-record",
      heroImage: "/images/projects/jinshihu-detention-pond/boardwalk.webp",
      location: "高雄市金獅湖周邊",
      period: "民國101年度（2012）",
      summary: "金獅湖滯洪池周邊地景環境改造工程，影像涵蓋湖岸整地、植栽施作、木棧步道及園區鋪面，呈現施工過程與周邊公共空間現況。",
      scope: [
        "周邊地景環境改造工程監造",
        "湖岸整地與植栽施工紀錄",
        "木棧步道與園區鋪面紀錄",
      ...
      sections: [],
      photos: [
        { src: "/images/projects/jinshihu-detention-pond/boardwalk.webp", caption: "金獅湖周邊木棧步道與植栽" },
        { src: "/images/projects/jinshihu-detention-pond/park-path.webp", caption: "林蔭步道與園區通行環境" },
        { src: "/images/projects/jinshihu-detention-pond/plaza-landscape.webp", caption: "園區鋪面、停車設施與景觀配置" },
        { src: "/images/projects/jinshihu-detention-pond/shore-construction.webp", caption: "湖岸周邊整地與現場施工作業" },
        { src: "/images/projects/jinshihu-detention-pond/shore-planting.webp", caption: "湖岸植栽與周邊步道施工紀錄" },
      ],
    },
  },
];

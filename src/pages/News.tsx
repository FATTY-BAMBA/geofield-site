              ...
              <Reveal key={article.slug} delay={index * 0.06} className="h-full">
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col p-6 lg:p-8">
                    ...
                    <h3 className="editorial-heading mt-5 text-xl font-extrabold leading-relaxed text-brand-900 transition-colors group-hover:text-emerald2-600 lg:text-2xl">
                      {article.title}
                    </h3>
                    <p className="editorial-copy mt-4 text-base text-slate-600">{article.excerpt}</p>
                    <div className="mt-auto flex items-center justify-between gap-3 pt-7 text-sm font-bold text-emerald2-700">
                      <span>查看活動紀錄</span>
